  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        <input className='hidden' onChange={(e)=>setFile(e.target.files[0])} type="file"  ref={fileRef} accept='image/*'/>
        ...
        <button disabled={loading} className='bg-slate-700 rounded-lg text-white p-3 uppercase hover:opacity-90 disabled:opacity-80'>{loading ? "Loading..." : "update"}</button>
